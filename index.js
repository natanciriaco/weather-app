...
search.addEventListener('submit',(event)=>{
    ...
    const APIKey = 'b8b189110e03e361da4d8b8e94c32174'
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${APIKey}`).then(response => response.json()).then(json => {
        ...
        const temperatureCelsius = (json.main.temp) - 273.15
        temperature.innerHTML = `${parseInt(temperatureCelsius)}<span>°C</span>`
